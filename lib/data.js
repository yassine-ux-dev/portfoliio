...
const languages = [
  ...
  },
  {
    ...
    icon: <SiDotnet />,
    color: "#239120",
    desc: "C# is a modern, object-oriented programming language developed by Microsoft.",
  },
  {
    name: "entityframework",
    icon: <SiDotnet />,
    color: "#512BD4",
    desc: "Entity Framework is an open-source ORM framework for .NET applications.",
  },
];
